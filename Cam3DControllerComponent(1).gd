...
## It is preferable that this node should be a direct child of the camera
## it is acting on, and that camera be a direct child of the CharacterBody3D
## it is acting on. IMPORTANT: THE ESC KEY IS TAKEN UP BY THIS SCRIPT, SO
## DON'T USE IT IN THE INPUT MAP.
